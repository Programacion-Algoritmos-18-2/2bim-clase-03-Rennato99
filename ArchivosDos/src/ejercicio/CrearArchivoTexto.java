...
public class CrearArchivoTexto
{
   ...
   public void abrirArchivo()
   {
      try
      {
         salida = new Formatter( "persona.txt" );
      } // fin de try
   ...
   public void agregarRegistros()
   {
      ...
      while ( bandera == true ) // itera hasta encontrar el indicador de fin de archivo
      {
         try // envia valores al archivo
         {
            ...
            persona.setName( entrada.nextLine() ); // lee el n�mero de cuenta
            System.out.println("Ingrese la edad de la persona: ");
            persona.setAge( entrada.nextInt() ); // lee el primer nombre
            ...
            {
               System.out.println(
                  "El numero de edad debe ser mayor que 0." );
            } // fin de else
            System.out.println("Desea ingresar más personas si (1), no(2)");
